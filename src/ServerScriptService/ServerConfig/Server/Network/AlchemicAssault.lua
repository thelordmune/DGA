...
NetworkModule.EndPoint = function(Player, Data)
	...
	if canUseSkill and not Server.Library.CheckCooldown(Character, "AlchemicAssault") then
		cleanUp()
		Server.Library.SetCooldown(Character,"AlchemicAssault",10) -- Increased from 7 to 10 seconds
