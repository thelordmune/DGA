...
Interface.InitInventory = function()
	if self.Modules["InventoryManager"] and self.Modules["InventoryManager"].new then
		local inventory = self.Modules["InventoryManager"].new()
