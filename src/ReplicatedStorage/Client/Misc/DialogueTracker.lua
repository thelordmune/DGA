...
DialogueTracker.Start = function()
    ...
    local pent = ref.get("player", Players:GetPlayerFromCharacter(Character))
    print("DIALOGUE TRACKER DEBUG: Entity ID for", Players:GetPlayerFromCharacter(Character).Name, ":", pent)
