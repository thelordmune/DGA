...
-- OPTIMIZATION: Cache query for getAllActiveQuests
local activeQuestQuery = world:query(comps.ActiveQuest, comps.Player):cached()
...
function QuestManager.getAllActiveQuests()
    ...
    for entity in activeQuestQuery do
